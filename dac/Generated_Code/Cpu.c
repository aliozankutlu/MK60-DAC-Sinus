...
void PE_low_level_init(void)
{
  ...
  /* NVICIP72: PRI72=0x30 */
  NVICIP72 = NVIC_IP_PRI72(0x30);                                   
  /* NVICIP68: PRI68=0 */
  NVICIP68 = NVIC_IP_PRI68(0x00);                                   
  /* NVICIP69: PRI69=0 */
  NVICIP69 = NVIC_IP_PRI69(0x00);                                   
  /* NVICIP70: PRI70=0 */
  NVICIP70 = NVIC_IP_PRI70(0x00);                                   
  /* NVICIP71: PRI71=0 */
  NVICIP71 = NVIC_IP_PRI71(0x00);                                   
  /* NVICIP20: PRI20=0 */
  NVICIP20 = NVIC_IP_PRI20(0x00);                                   
  /* NVICISER2: SETENA|=0x30 */
  NVICISER2 |= NVIC_ISER_SETENA(0x30);                                   
  /* ### Init_PDB "PDB" init code ... */
  /* ### Call "PDB_Init();" init method in a user code, i.e. in the main code */

  /* ### Note:   To enable automatic calling of the "PDB" init code here,
                 the 'Call Init method' property must be set to 'yes'.
   */
  /* ### Init_PIT "modulePIT0" init code ... */
  /* ### Call "modulePIT0_Init();" init method in a user code, i.e. in the main code */

  /* ### Note:   To enable automatic calling of the "modulePIT0" init code here,
                 the 'Call Init method' property must be set to 'yes'.
   */
