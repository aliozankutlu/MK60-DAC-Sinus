...
*/         
  ...
  __attribute__ ((section (".vectortable"))) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&DMA1_Channel0Interrupt, /* 0x10  0x00000040   8   ivINT_DMA0_DMA16               used by PE */
    ...
    (tIsrFunc)&delayInterrupt,         /* 0x54  0x00000150   0   ivINT_PIT0                     used by PE */
    ...
    (tIsrFunc)&PDB_ISR,                /* 0x58  0x00000160   3   ivINT_PDB0                     used by PE */
    ...
    (tIsrFunc)&Cpu_Interrupt,          /* 0x61  0x00000184   8   ivINT_DAC0                     unused by PE */
